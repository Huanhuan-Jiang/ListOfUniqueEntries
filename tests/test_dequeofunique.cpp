...
TEST(DequeOfUniqueTest, MoveAssignmentIsNoexcept) {
  ...
  static_assert(
      noexcept(
          std::declval<containerofunique::deque_of_unique<std::string> &>() =
              std::declval<
                  containerofunique::deque_of_unique<std::string> &&>()),
